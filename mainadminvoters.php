...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Kisii University Student List</h3>
				...
				<a href="addvoters.php" class = "btn btn-primary btn-outline"><i class = "fa fa-paw"></i> Add Voters</a>
				...
				<a  href = "deactivate_acc.php"class = "btn btn-danger btn-outline pull-right" style = "margin-right:12px;" name = "go"><i class = "fa fa-asterisk fa-spin"></i> Deactivate All Voters Account</a>
