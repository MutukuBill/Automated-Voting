<nav class="navbar navbar-default navbar-static-top navbar-primary navbar-fixed" role="navigation" style="margin-bottom:6px;background-color:#0022ff;color:white;">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="" style = "color:white;"> Kisii University</a>
					<button class="button button3" style="background-color:blue" onclick="document.location='studlogout.php' ">Log Out</button>
            </div>
