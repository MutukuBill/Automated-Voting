    ...
    <div id="row">
		...
		?>
		  ...
		  <div class = "alert alert-info">
			...
			<div class = "alert alert-success" >
			<label>VICE PRESIDENT WELFARE</label>
			<br />
			<?php
			...
			<div class = "alert alert-info">
			<label>VICE HALLS COORDINATOR</label>
			<br />
			<?php
			...
			<div class = "alert alert-info">
			<label>STUDENT LEADER FACULTIES</label>
			<br />
			<?php
