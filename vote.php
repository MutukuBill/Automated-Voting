...
<body>
	...
	<div class="col-lg-6">
				...
				<div class="col-lg-6">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading"><center>
							VICE PRESIDENT ACADEMICS</center>
                        </div>
                        <div class="panel-body" style = "background-color:;">
						<?php
	...
	<div class="col-lg-6">
	  <div class="panel panel-primary">
			...
			<center>VICE PRESIDENT ADMINISTRATION</center>
            </div>
            <div class="panel-body" style = "background-color:;">
				<?php
	...
	<div class="col-lg-6">
	  <div class="panel panel-primary">
            <div class="panel-heading">
			<center>VICE PRESIDENT WELFARE</center>
            </div>
            <div class="panel-body" style = "background-color:;">
				<?php
	...
	<div class="col-lg-6">
	  <div class="panel panel-primary">
            <div class="panel-heading">
			<center>HALLS COORDINATOR</center>
            </div>
            <div class="panel-body" style = "background-color:;">
				<?php
	...
	<div class="col-lg-6">
	  <div class="panel panel-primary">
            <div class="panel-heading">
			<center>VICE HALLS COORDINATOR</center>
            </div>
            <div class="panel-body" style = "background-color:;">
				<?php
	...
	<div class="col-lg-6">
	  <div class="panel panel-primary">
            <div class="panel-heading">
			<center>RELIGIOUS LEADER</center>
            </div>
            <div class="panel-body" style = "background-color:;">
				<?php
	...
	<div class="col-lg-6" style = "margin-left:350px;">
	  <div class="panel panel-primary">
            <div class="panel-heading">
			<center>STUDENT LEADER FACULTIES</center>
            </div>
            <div class="panel-body" style = "background-color:;">
				<?php
